...
def generate_scratchblocks(project, surround):
    ...
    for target in targets:
        for block_id, block in target["blocks"].items():
            ...
            if is_start:
                script = generate_script(block_id, target["blocks"], block_ids=surround)
